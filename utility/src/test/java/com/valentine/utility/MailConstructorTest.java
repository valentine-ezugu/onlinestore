...
public class MailConstructorTest {
    ...
    @Test
    public void constructorResetTokenEmailTest() throws Exception {
        ...
        String password = "xcvjdjvkdjwkihndvkdowwess";
        ...
        SimpleMailMessage message1 = mailConstructor.constructorResetTokenEmail(contextPath, request.getLocale(), token, user, password);
