...
public class CartItemServiceTest {
    ...
    public void findByIdException() {
        ...
        when(cartItemRepository.findOne(1L)).thenThrow(new DataAccessException("") {
        });
    ...
    public void findByCategoryException() {
        ...
        when(cartItemRepository.findByShoppingCart(shoppingCart)).thenThrow(new DataAccessException("") {
        });

        CartItemService service = new CartItemServiceImpl(cartItemRepository);
        exception.expect(DataAccessException.class);
        service.findByShoppingCart(shoppingCart);
